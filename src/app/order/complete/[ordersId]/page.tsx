...
export default function OrderCompletePage() {
  // ✅ Next 15에서는 클라이언트에서 useParams()로 읽는 방식이 안전
  ...
  return (
    <main className="mx-auto max-w-[600px] px-4 py-10 text-center">
      <h1 className="text-[36px] font-semibold mb-6 mt-[60px]"><PawIcon/>&nbsp;주문이 완료되었습니다&nbsp;<PawIcon/></h1>
  ...
  {/* ▶ 구매내역 버튼: 버튼 크기(px/py), 글씨 크기/색 조정 */}
