...
public class HotelCancelNotificationService {
    ...
    public void notifyHotelCancel(MemberEntity member, String memberId, VenueEntity venue, LocalDate in, LocalDate out) {
        ...
        String title = member.getMemberName() + " 회원님, " + formattedIn + " ~ " + formattedOut + " 안펫나 호텔 " + venue.getVenueName() + " 예약이 취소되었습니다.";

        notificationService.createAndPush(
                CreateNotificationCmd.builder()
                        .receiverMemberId(memberId)
                        .notificationType(NotificationType.RESERVATION_HOTEL_CANCELED)
